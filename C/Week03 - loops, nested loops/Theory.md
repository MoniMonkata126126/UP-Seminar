...
- В частност, ``while (1)`` е безкраен цикъл, който никога* няма да спре да изпълнява тялото си, а ``while (0)`` е цикъл, който никога няма да се изпълни, т.е. ще бъде директно пропуснат.\
\
