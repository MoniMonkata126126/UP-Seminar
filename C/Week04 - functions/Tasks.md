...
# Зад 6
Да се състави програма, която въвежда от клавиатурата цяло положително число n. Напишете функция, която връща двоичната му репрезентация. Изберете подходящи типове. Изведете резулат
```
Вход: 123
Изход: 1111011
```
